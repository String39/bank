...
public class BaseDatosMercado {
	...
	static {
		...
		tablaProducto.put(contador, new Producto(contador,"Lapiz2",3.0));contador++;
		tablaProducto.put(contador, new Producto(contador,"Lapiz3",3.0));contador++;
		tablaProducto.put(contador, new Producto(contador,"Lapiz4",3.0));contador++;
	}
